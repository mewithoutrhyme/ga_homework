...
const apiKey = "ccToszS1hILm9edxzX6P6DKBGveYj4eC";
...
// set ALt attribute
const altAtt = document.createElement("alt");
altAtt.setAttribute("alt", giphyData.data[i].title);
document.getElementById("giphy-results").append(altAtt);
